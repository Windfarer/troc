...
class Species(models.Model):
    ...
    origin = models.CharField(max_length=200, null=True, verbose_name="源产地")
    habitats = models.CharField(max_length=200, null=True, verbose_name="生境")
    part = models.CharField(max_length=200, null=True, verbose_name="食用部位")
    type = models.CharField(max_length=200, null=True, verbose_name="食物种类")

    created_at = models.DateTimeField(default=timezone.now)
    updated_at = models.DateTimeField(default=timezone.now)
    tax_id = models.BigIntegerField(null=True)
